...
// // //   const [roomFetchError, setRoomFetchError] = useState(null); // NEW: error state for room fetch
...
// // //         navigate('/booking');
// // //       } else {
// // //         setMessage(`Update failed: ${typeof data.error === 'string' ? data.error : JSON.stringify(data)}`);
// // //       }
// // //     } catch (error) {
...
// // //   return (
// // //     <div className="min-h-screen w-full bg-gradient-to-br from-yellow-50 to-white p-0 m-0">
// // //       <div className="w-full p-0 m-0">
    
// // //         <h1 className="text-4xl font-extrabold text-center mb-10 tracking-tight text-primary pt-8">Booking Form</h1>
...
// // //         <form onSubmit={handleSubmit} className="space-y-12 w-full max-w-full px-2 sm:px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-48 overflow-x-auto" autoComplete="off">
// // //           {/* Guest Details Section */}
        
// // //         {/* <section className="rounded-2xl shadow p-8 border-2 border-primary/20 w-full max-w-full mx-auto bg-gradient-to-br from-white to-yellow-50"> */}
// // //   {/* <section className="rounded-2xl shadow p-8 border border-gray-200 w-full max-w-7xl mx-auto   bg-white"> */}
// // //   <section className="rounded-2xl shadow p-8 border-2 border-primary/20 w-full max-w-screen-2xl mx-auto bg-gradient-to-br from-white to-yellow-50">
// // //             <h3 className="text-xl font-bold mb-6  text-primary flex items-center gap-2 border-b pb-2 border-gray-100">
...
// // //  <InputWithIcon icon={<FaUser />} type="text" placeholder="Guest Name" onChange={(e) => handleChange("guestName", e.target.value)} value={formData.guestName || ''} inputClassName="bg-white border border-secondary rounded-lg pl-10 pr-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary w-full" />
// // //               <InputWithIcon icon={<FaGlobe />} type="text" placeholder="Nationality" onChange={(e) => handleChange("nationality", e.target.value)} value={formData.nationality || ''} inputClassName="bg-white border border-secondary rounded-lg pl-10 pr-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary w-full" />
// // //               <InputWithIcon icon={<FaCity />} type="text" placeholder="City" onChange={(e) => handleChange("city", e.target.value)} value={formData.city || ''} inputClassName="bg-white border border-secondary rounded-lg pl-10 pr-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary w-full" />
// // //               <InputWithIcon icon={<FaMapMarkedAlt />} type="text" placeholder="Address" onChange={(e) => handleChange("address", e.target.value)} value={formData.address || ''} inputClassName="bg-white border border-secondary rounded-lg pl-10 pr-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary w-full" />
// // //               <InputWithIcon icon={<FaPhone />} type="text" placeholder="Phone No" onChange={(e) => handleChange("phoneNo", e.target.value)} value={formData.phoneNo || ''} inputClassName="bg-white border border-secondary rounded-lg pl-10 pr-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary w-full" />
// // //               <InputWithIcon icon={<FaMobileAlt />} type="text" placeholder="Mobile No" onChange={(e) => handleChange("mobileNo", e.target.value)} value={formData.mobileNo || ''} inputClassName="bg-white border border-secondary rounded-lg pl-10 pr-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary w-full" />
// // //               <InputWithIcon icon={<FaEnvelope />} type="email" placeholder="Email" onChange={(e) => handleChange("email", e.target.value)} value={formData.email || ''} inputClassName="bg-white border border-secondary rounded-lg pl-10 pr-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary w-full" />
// // //             </div>
// // //           </section>

// // //           {/* Contact Details Section - UI only */}
// // //           <section className="rounded-2xl shadow p-8 border-2 border-primary/20 w-full bg-gradient-to-br from-white to-yellow-50">
// // //             <h3 className="text-2xl font-bold mb-8 text-primary flex items-center gap-3 border-b pb-2 border-primary/10">
// // //               <FaAddressBook className="text-primary" /> Contact Details
// // //             </h3>
// // //             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
// // //               <InputWithIcon icon={<FaUser />}  type="text" placeholder="Contact Person" onChange={(e) => handleChange("contactPerson", e.target.value)} value={formData.contactPerson || ''} inputClassName="bg-white border border-secondary rounded-lg pl-10 pr-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary" />
// // //               <InputWithIcon icon={<FaMobileAlt />} type="text" placeholder="Contact Mobile No" onChange={(e) => handleChange("contactMobile", e.target.value)} value={formData.contactMobile || ''} inputClassName="bg-white border border-secondary rounded-lg pl-10 pr-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary" />
// // //               <InputWithIcon icon={<FaEnvelope />} type="email" placeholder="Contact Email" onChange={(e) => handleChange("contactEmail", e.target.value)} value={formData.contactEmail || ''} inputClassName="bg-white border border-secondary rounded-lg pl-10 pr-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary" />
// // //             </div>
// // //           </section>
...
// // //           <section className="rounded-2xl shadow p-8 border-2 border-primary/20 w-full bg-gradient-to-br from-white to-yellow-50">
// // //             <h3 className="text-2xl font-bold mb-8 text-primary flex items-center gap-3 border-b pb-2 border-primary/10">
// // //               <FaIdCard className="text-primary" /> Identity Details
// // //             </h3>
// // //             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
...
// // //                 </select>
// // //               </div>
// // //               <InputWithIcon icon={<FaIdCard />} type="text" placeholder="ID Number" onChange={(e) => handleChange("idNumber", e.target.value)} value={formData.idNumber || ''} inputClassName="bg-white border border-secondary rounded-lg pl-10 pr-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary" />
// // //             </div>
...
// // //             </div>
// // //             {showCamera && (
// // //               <div className="mt-6 p-4 border border-gray-300 rounded-md flex flex-col items-center bg-gray-50">
...
// // //                     <img src={img} alt={`ID Proof ${idx + 1}`} className="max-w-xs h-auto rounded-md border-2 border-primary/30" />
// // //                     <button
// // //                       type="button"
...
// // //           <section className="rounded-2xl shadow p-8 border-2 border-primary/20 w-full bg-gradient-to-br from-white to-yellow-50">
// // //             <h3 className="text-2xl font-bold mb-8 text-primary flex items-center gap-3 border-b pb-2 border-primary/10">
// // //               <FaFileInvoiceDollar className="text-primary" /> Booking Info
// // //             </h3>
// // //             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
// // //               {/* Room Dropdown: show all available rooms with category */}
// // //               <div className="relative w-full">
// // //                 <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none">
// // //                   <FaDoorOpen />
// // //                 </span>
...
// // //                   ) : null}
// // //                   {availableRooms.length === 0 && !roomFetchError ? (
// // //                     <div className="text-yellow-600 font-semibold mb-2">No rooms found.</div>
// // //                   ) : null}
// // //                   <Select
// // //                     options={availableRooms
// // //                       .map(room => ({
// // //                         value: room._id,
// // //                         label: `${room.title} (#${room.room_number}) - ${room.category && room.category.name} [${room.status}]`
// // //                       }))}
// // //                     value={(() => {
// // //                       const selectedRoom = availableRooms.find(room => room._id === formData.roomAssigned);
// // //                       return selectedRoom ? {
// // //                         value: selectedRoom._id,
// // //                         label: `${selectedRoom.title} (#${selectedRoom.room_number}) - ${selectedRoom.category && selectedRoom.category.name} [${selectedRoom.status}]`
// // //                       } : null;
// // //                     })()}
// // //                     onChange={option => {
...
// // //                         borderColor: state.isFocused ? '#f59e42' : '#e2e8f0', // focus:ring-primary or border-secondary
// // //                         borderWidth: '1px',
// // //                         borderRadius: '0.5rem',
// // //                         boxShadow: state.isFocused ? '0 0 0 2px #f59e42' : base.boxShadow,
// // //                         outline: state.isFocused ? '2px solid #f59e42' : base.outline,
...
// // //                           ? '#f59e42' // bg-primary
// // //                           : state.isFocused
// // //                           ? 'rgba(245, 158, 66, 0.1)' // bg-primary/10
// // //                           : 'white',
...
// // //               <InputWithIcon icon={<FaCalendarAlt />} type="date" placeholder="Check-In Date" onChange={(e) => handleChange("checkInDate", e.target.value)} value={formData.checkInDate || ''} inputClassName="bg-white border border-secondary rounded-lg pl-10 pr-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary" />
// // //               <InputWithIcon icon={<FaClock />} type="time" placeholder="Check-In Time" onChange={(e) => handleChange("checkInTime", e.target.value)} value={formData.checkInTime || ''} inputClassName="bg-white border border-secondary rounded-lg pl-10 pr-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary" />
// // //               <InputWithIcon icon={<FaCalendarAlt />} type="date" placeholder="Check-Out Date" onChange={(e) => handleChange("checkOutDate", e.target.value)} value={formData.checkOutDate || ''} inputClassName="bg-white border border-secondary rounded-lg pl-10 pr-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary" />
// // //               <InputWithIcon icon={<FaClock />} type="time" placeholder="Check-Out Time" onChange={(e) => handleChange("checkOutTime", e.target.value)} value={formData.checkOutTime || ''} inputClassName="bg-white border border-secondary rounded-lg pl-10 pr-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary" />
// // //               <InputWithIcon icon={<FaUsers />} type="number" placeholder="No. of Rooms" onChange={(e) => handleChange("noOfRooms", e.target.value)} value={formData.noOfRooms || ''} inputClassName="bg-white border border-secondary rounded-lg pl-10 pr-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary" />
// // //               <InputWithIcon icon={<FaUsers />} type="number" placeholder="No. of Adults" onChange={(e) => handleChange("noOfAdults", e.target.value)} value={formData.noOfAdults || ''} inputClassName="bg-white border border-secondary rounded-lg pl-10 pr-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary" />
// // //               <InputWithIcon icon={<FaUsers />} type="number" placeholder="No. of Children" onChange={(e) => handleChange("noOfChildren", e.target.value)} value={formData.noOfChildren || ''} inputClassName="bg-white border border-secondary rounded-lg pl-10 pr-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary" />

// // //               <InputWithIcon icon={<FaMoneyCheckAlt />} type="number" placeholder="Rate" onChange={(e) => handleChange("rate", e.target.value)} value={formData.rate || ''} inputClassName="bg-white border border-secondary rounded-lg pl-10 pr-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary" />
// // //             </div>
// // //           </section>
...
// // //             </h3>
// // //             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
// // //               <InputWithIcon icon={<FaCashRegister />} type="text" placeholder="Payment Mode" onChange={(e) => handleChange("paymentMode", e.target.value)} value={formData.paymentMode || ''} inputClassName="bg-white border border-secondary rounded-lg pl-10 pr-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary" />
// // //               <InputWithIcon icon={<FaMoneyCheckAlt />} type="number" placeholder="Advance Amount" onChange={(e) => handleChange("advanceAmount", e.target.value)} value={formData.advanceAmount || ''} inputClassName="bg-white border border-secondary rounded-lg pl-10 pr-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary" />
// // //             </div>
// // //           </section>
...
// // //             <button
// // //               type="button"
// // //               className="bg-gray-200 text-gray-700 px-8 py-3 rounded-lg text-lg font-semibold shadow hover:bg-gray-300 transition-all"
// // //               onClick={onClose}
// // //             >
// // //               Cancel
// // //             </button>
// // //             <button
// // //               type="submit"
// // //               className="bg-primary text-white px-10 py-3 rounded-lg text-lg font-semibold shadow hover:bg-primary-dark transition-all"
// // //             >
// // //               Submit Booking
// // //             </button>
// // //           </div>
...
// //       <form onSubmit={handleSubmit} className="space-y-8"> {/* Changed from space-y-12 to space-y-8 for consistency */}
// //         {/* Guest Details Section */}
...
// //           </h3>
// //           <div className="grid md:grid-cols-3 gap-6"> {/* Changed to md:grid-cols-3 and gap-6 */}
// //             <div className="relative flex items-center"> {/* Adjusted for InputWithIcon consistency */}
...
// //               <div className="w-full"> {/* Removed pl-10 from here as InputWithIcon handles it */}
// //                 {roomFetchError ? (
// //                   <div className="text-red-600 font-semibold mb-2">Error loading rooms: {roomFetchError}</div>
// //                 ) : null}
// //                 {availableRooms.length === 0 && !roomFetchError ? (
...
// //                       ...base,
// //                       backgroundColor: 'white',
// //                       borderColor: state.isFocused ? 'var(--color-primary)' : 'var(--color-secondary)', // focus:ring-primary or border-secondary
// //                       borderWidth: '1px',
// //                       borderRadius: '0.5rem',
...
// //             <div className="relative flex items-start md:col-span-3"> {/* Full width textarea */}
...
// //         {/* Submit and Cancel Buttons */}
// //         <div className="mt-8 flex justify-center gap-4"> {/* Adjusted margin and alignment */}
// //           <button
// //             type="button"
...
//     purposeOfVisit: "",
//     remarks: "",
//     grcNo: "", // Added GRC No to form data
//   });
//   const [showCamera, setShowCamera] = useState(false);
...
//           onBookingSuccess(data.booking);
//         }
//         // No navigate here if you want to display the GRC No after submission
//         // navigate('/booking'); // Removed this line to keep form visible with GRC No

//         // Optionally, reset other form fields after successful submission,
//         // but keep GRC No for display.
//         // If you want to clear the form completely, move the GRC No capture before this reset.
//         // For now, GRC No will persist until a new form instance or manual clear.
//         /*
//         setFormData({
//           idImages: [],
//           selectedCategoryId: "",
...
//           purposeOfVisit: "",
//           remarks: "",
//           grcNo: data.booking?.grcNo || "", // Keep GRC No here if clearing other fields
//         });
//         */
//       } else {
...
//              {/* GRC No. Field - Display only if available */}
//              {formData.grcNo && (
//                 <InputWithIcon
